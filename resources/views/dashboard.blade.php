                            ...
                            <div id="managerInfo" class=" ishidden">
                                    ...
                                    <div id="EmployeeManagerTab" class="managerTab">
                                        ...
                                        <div class="contentdiv">
                                            <div class = "tabBtns">
                                                <button id="empListBtn"><p>Employee List</p></button>
                                                <button id="empInfoBtn"><p>Employee Info</p></button>
                                                <button id="empAddBtn"><p>Add Employee</p></button>
                                            </div>
                                    ...
                                    <div id="RoleManagerTab" class="managerTab">
                                        ...
                                        <div  class="contentdiv">
                                            <div class = "tabBtns">
                                                <button id="roleListBtn"><p>Role List</p></button>
                                                <button id="roleInfoBtn"><p>Role Info</p></button>
                                                <button id="roleAddBtn"><p>Add Role</p></button>
                                            </div>
                                            <div class="contenttabs">
                                                <div id="roleList">
                                ...
                                <div id="ManagerWindowWrapper">
                                    <div class="managerwindow">
                                        <div class="managerwindowtab">
                                            <p id ="timeLabel">03:06:42<br>lol</p>
                                        </div>
                                    </div>
                                    <div class="managerwindow">
                                        <div class="managerwindowtab">
                                            <p id ="roleLabel1">Cook</p>
...
role.generate(scheduler.currentDate.getDateAfterDays(2).toArrayMMDDYYY(),7);
